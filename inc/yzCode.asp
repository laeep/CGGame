...
Const nAngleRandom = 5 
Const nLengthRandom = 5
Const nColorHue = 500
...
Call CreatValidCode("verifycode")
sub CDGen_Reset()
	LineCount = 0
	tmp_X_1_ = 0
	tmp_Y_1_ = 0
...
End Function
Sub CreatValidCode(Fy0)
	Dim i, j, CurColorHue
	CDGen
	Session(Fy0) = lcase(str_Digtal)	'记录入Session
